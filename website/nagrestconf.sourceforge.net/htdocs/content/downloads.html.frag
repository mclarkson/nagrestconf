      ...
      <div class="row" style="padding-left:10px;padding-right:20px;">
        <h1>Downloads</h1>
          ...
          <tr>
          <td>Raspberry Pi</td>
          <td><a href="https://sourceforge.net/projects/nagrestconf/files/Debian/">Latest Pi packages</a></td>
          <td>1.172</td>
          <td><a href="/installguides/raspberrypi.php">Install Guide</a></td>
          <!--<td>Use the debian package.</td>-->
          </tr>
          <tr>
          <td>Redhat 5</td>
