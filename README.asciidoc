...
++++
<img src="http://www.smorg.co.uk/images/HostsTab_1_160.png"
...
++++
<img src="http://www.smorg.co.uk/images/ServicesBulkTools_1_160.png"
...
# On Debian:
apt-get update
gdebi nagrestconf_1.160_all.deb \
      nagrestconf-services-plugin_1.160_all.deb \
      nagrestconf-services-bulktools-plugin_1.160_all.deb \
      nagrestconf-hosts-bulktools-plugin_1.160_all.deb

# On Centos/Redhat:
yum install nagrestconf-1.160-1.noarch.rpm \
            nagrestconf-services-tab-plugin-1.160-1.noarch.rpm \
            nagrestconf-services-bulktools-plugin-1.160-1.noarch.rpm \
            nagrestconf-hosts-bulktools-plugin-1.160-1.noarch.rpm
