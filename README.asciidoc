...
16 Jan 2013 New version 1.170 (released for all platforms)

* Minor bug fixes.

16 Jan 2013 (synagios.spk for ARM released to sourceforge)
...
15 Jan 2013 (synagios.spk for x86 released to sourceforge)
...
Nagrestconf running on a Synology Diskstation DS412+ NAS device.

++++
<img src="http://www.smorg.co.uk/images/SynologyDSM_1_171.png"
...
.*DEBIAN, UBUNTU, FEDORA, CENTOS & REDHAT*
...
*SYNOLOGY DSM 4.3+ x86/arm DEVICES*

Download the package, synagios.spk, for your device from sourceforge:

https://sourceforge.net/projects/nagrestconf/files/synology

In the DSM Desktop open the 'Package Center' then choose 'Manual Install' and 'Browse' for the synology_0.10.spk file.

Set passwords for nagiosadmin, and nagrestconfadmin.

After installation use nagrestconf to restore the example configuration,
nagcfgbak_xxx.tgz, which is also in the synology directory at sourceforge.

To open the nagios GUI use: http://diskstation:8888/nagios3

To open the nagrestconf GUI click the Synagios icon in DSM or open, http://diskstation:8888/nagrestconf.
