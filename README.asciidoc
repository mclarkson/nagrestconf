...
23 Jan 2014 Web site goes live, but it is still under construction.

* See: http://nagrestconf.sourceforge.net/

20 Jan 2014 New version 1.172 (released for all platforms)
...
Refer to the 'Installation Guides' section at http://nagrestconf.sourceforge.net/installguide.html
