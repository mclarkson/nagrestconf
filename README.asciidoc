...
* Servicesets field in hosts now accepts multiple service sets. Service sets added from left to right; any duplicate services are overwritten by the rightmost serviceset.
* Various bug fixes.
