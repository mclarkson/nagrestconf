...
======================================
This is the Bulk Tools plugin for the Hosts tab.
...
* Delete Hosts
  All hosts shown in the hosts tab will be affected.
* Refresh Hosts
  All services for a host are deleted and reapplied using whatever
hosts are entered in the servicesets field.
  All hosts shown in the hosts tab will be affected.
* Add Hosts
