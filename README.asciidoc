...
gdebi nagrestconf_1.168_all.deb \
      nagrestconf-services-plugin_1.168_all.deb \
      nagrestconf-services-bulktools-plugin_1.168_all.deb \
      nagrestconf-hosts-bulktools-plugin_1.168_all.deb \
      nagrestconf-backup-plugin_1.168_all.deb

# On Centos/Redhat:
yum install nagrestconf-1.168-1.noarch.rpm \
            nagrestconf-services-tab-plugin-1.168-1.noarch.rpm \
            nagrestconf-services-bulktools-plugin-1.168-1.noarch.rpm \
            nagrestconf-hosts-bulktools-plugin-1.168-1.noarch.rpm \
            nagrestconf-backup-plugin-1.168-1.noarch.rpm
