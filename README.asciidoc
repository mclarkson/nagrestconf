...
----
                  ...
                  |   Thruk GUI could be used to   |     servers using the mod_gearman protocol
   ...
   Web GUI  ==>   |--->----| Nagios       |        |---<---|
                  ...
                  |                                |       |       \
                  |                                |                \                       
                  |                                |            nagrestconf sends configuration to master
                  |                                |            nagios using subversion mirroring
----
