...
09 Jan 2013 New version 1.167 (redhat 5/6 and debian packages released to Sourceforge)
...
# On Debian:
apt-get update
gdebi nagrestconf_1.167_all.deb \
      nagrestconf-services-plugin_1.167_all.deb \
      nagrestconf-services-bulktools-plugin_1.167_all.deb \
      nagrestconf-hosts-bulktools-plugin_1.167_all.deb \
      nagrestconf-backup-plugin_1.167_all.deb

# On Centos/Redhat:
yum install nagrestconf-1.167-1.noarch.rpm \
            nagrestconf-services-tab-plugin-1.167-1.noarch.rpm \
            nagrestconf-services-bulktools-plugin-1.167-1.noarch.rpm \
            nagrestconf-hosts-bulktools-plugin-1.167-1.noarch.rpm \
            nagrestconf-backup-plugin-1.167-1.noarch.rpm
