...
|===========================================================================================================
| Column | Description                   | Flags   | REST variable name        | Nagios argument name
| 1.     | Serviceset name               | XRK     | name                      | N/A      
| 2.     | Service template              | XR      | template                  | use
| 3.     | Service command               | XR      | command                   | check_command
| 4.     | Service description           | XRK     | svcdesc                   | service_description
| 5.     | Service groups                | XL      | svcgroup                  | servicegroups
| 6.     | Contacts                      | XL      | contacts                  | contacts
| 7.     | Contact groups                | XL      | contactgroups             | contact_groups
| 8.     | Freshness threshold (auto)*   | X       | freshnessthresh           | N/A
| 9.     | Active checks                 | X       | activechecks              | active_checks_enabled
| 10.    | Custom variables              | XC      | customvars                | N/A
| 11.    | Disable                       | XU      | disable                   | 
| 12.    | Display name                  | X       | displayname               | display_name
| 13.    | Is volatile                   | X       | isvolatile                | is_volatile
| 14.    | Initial state                 | X       | initialstate              | initial_state
| 15.    | Max check attempts            | X       | maxcheckattempts          | max_check_attempts
