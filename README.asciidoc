...
20 Jun 2013 New version 1.153 (unreleased)

* Jquery and theme update. Started adding tabs to dialogs to support extra options.
...
* Add ALL nagios options supported by REST to the GUI. 

* Add urlencoding to the `Commands' page.
